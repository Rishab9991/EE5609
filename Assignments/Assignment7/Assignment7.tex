...
%\end{align}
%\begin{align}
%\implies \mydet{\brak{\vec{AA^t}}^r} = 0 \label{eq:7}
%\end{align}
%But \eqref{eq:7} contradicts \eqref{eq:1} as $\brak{\vec{AA^t}}^r$ will not be a identity matrix if it has a determinant of 0. 
...
%begin{align}
%\mydet{\brak{\vec{AA^t}}^r} = \mydet{\vec{I}} = 1\\[1em]
