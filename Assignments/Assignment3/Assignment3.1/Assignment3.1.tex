...
% Different inputs were used in .tex and .py files
\begin{figure}[!ht]
    \centering
    \begin{tikzpicture}
      \draw[ultra thick, black](-1,6)--(-3,2)--(4,3)--(2,8)--cycle;
      %--(-7,8)--(2,11)--cycle
      %\draw[ultra thick, black][-Stealth](0,0)--(5,0);
      %\draw[ultra thick, black]%[Stealth-](5,0)--(0,5);
      \node at (-1,6)[above left]{\textbf{A}};
      \node at (-3,2)[below left]{\textbf{B}};
      \node at (4,3)[below right]{\textbf{C}};
      \node at (2,8)[above right]{\textbf{D}};
    \end{tikzpicture}
