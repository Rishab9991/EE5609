...
\end{align}
\begin{align}
i.e. \ \vec{q_1} = \myvec{7 \\ 6} \ for \ \kappa = 3 \label{eq:13}
\end{align}
and
\begin{align}
\vec{q_2} = \myvec{1 \\ 0} \ for \ \kappa = -3 \label{eq:14}
\end{align}
...
\begin{align}
c_1 =  \myvec{1 & 1}\myvec{7 \\ 6} = 13 \label{eq:20}
\end{align}
\begin{align}
c_2 = \myvec{1 & 1}\myvec{1 \\ 0} = 1 \label{eq:21}
\end{align}
\eqref{eq:19} is the given line \eqref{eq:1}\\\\
...
The above is all represented in the form of a Fig.\ref{Fig.1}.\\\\ $\vec{C}$ is the center of the circle. $\vec{q1}$ and $\vec{q2}$ are points of contact with the circle. \textbf{(Not drawn to scale)}.
\\\\
\begin{figure}[!ht]
    \centering
    \includegraphics{Figure.png}
    \caption{Tangents and Normal on a Circle}
    \label{Fig.1}
\end{figure}
\end{document}
