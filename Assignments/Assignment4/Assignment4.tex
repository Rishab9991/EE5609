...
\begin{align}
\vec{p_1} = \sqrt{\frac{10+2\sqrt{5}}{\sqrt{10}}}\myvec{1 \\ \frac{1-\sqrt{5}}{2}}\\ 
\vec{p_2} = \sqrt{\frac{10+2\sqrt{5}}{\sqrt{10}}}\myvec{1 \\ \frac{1-\sqrt{5}}{2}}
\end{align}
\begin{align}
\implies \vec{P} = \sqrt{\frac{10+2\sqrt{5}}{\sqrt{10}}}\myvec{1 & \frac{1-\sqrt{5}}{2} \\ 1 & \frac{1-\sqrt{5}}{2}}\\
...
\end{align}
Using the center and the parameters the ellipse can be plotted as follows.
In Fig. \ref{Fig.1}. $\vec{c}$ is the center of the ellipse, a and b are the lengths of the semi-minor and major axes respectively. 
\begin{figure}[!ht]
