...
Simplifying, 
\begin{align}
\implies \vec{P} = \myvec{0.850 & 0.525 \\ -0.525 & 0.850}\\
\vec{D} = \myvec{2.618 & 0 \\ 0 & 0.381}
\end{align}
...
\begin{align}
\vec{c} = \vec{-V^{-1}u}\\
\implies \vec{c} = \myvec{0 \\ 1}
\end{align}
The parameters of the ellipse are computed as follows,
\begin{align}
\sqrt{\frac{{\vec{u^{T}V^{-1}u} - f}}{\lambda_{1}}} = \sqrt{\frac{3-\sqrt{5}}{2}} = 0.437\\
\sqrt{\frac{{\vec{u^{T}V^{-1}u} - f}}{\lambda_{2}}} = \sqrt{\frac{3+\sqrt{5}}{2}} = 1.144
\end{align}
The angle of Rotation can be obtained by equating $\vec{P}$ with the Rotation matrix as follows.
\begin{align}
\myvec{0.850 & -0.525 \\ 0.525 & 0.850} = \myvec{\cos{\theta} & -\sin{\theta} \\ \sin{\theta} & \cos{\theta}}\\
\implies \theta = \frac{\pi}{5.66}
\end{align}
Using the center and $\theta$ the actual ellipse can be plotted with the help of standard ellipse as follows. $\vec{c}$ is the center of the actual ellipse, $\vec{o}$ is the center of the standard ellipse. 
\begin{figure}[!ht]
