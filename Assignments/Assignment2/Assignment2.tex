...
\implies \ A = e^{-j(\frac{n\pi}{2}-\alpha)}\label{equation:13}\\[1em]
A^T = \myvec{\sin{\alpha} \\ \cos{\alpha}} \\[1em]
\implies \ A^T = e^{j(\frac{n\pi}{2}-\alpha)}\label{equation:15}\\[1em]
...
%\implies A^TA = \myvec{1&&0\\0&&1}\myvec{1\\0}\\[1em]
\implies A^TA = e^{j(\frac{n\pi}{2}-\alpha)}e^{-j(\frac{n\pi}{2}-\alpha)} = 1 \\[1em]
\implies A^TA = I
\end{align}\\
